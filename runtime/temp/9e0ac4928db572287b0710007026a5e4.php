<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpStudy\WWW\localhost\tp50\public/../application/index\view\index\index.html";i:1517236519;s:80:"D:\phpStudy\WWW\localhost\tp50\public/../application/index\view\common\menu.html";i:1517224147;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="__STATIC__/home/css/common.css" />
...
<body>
    <div class="header-bar">
        <div class="header-inner">
            <ul class="father">
                 <li><a><?php echo $city['city_name']; ?></a></li>
                  <li>|</li>
                  <li class="city">
                    ...
                    <div class="city-drop-down">
                      ...
                      <ul class="son">
                        ...
                        <li><a href="<?php echo url('index/index', ['city'=>$vo['uname']]); ?>"><?php echo $vo['city_name']; ?></a></li>
              ...
              <?php endif; ?>
            <li><a href="<?php echo url('business/login/login'); ?>">商户中心</a></li>
    ...
    <div class="search">
        <a href="<?php echo url('index/index'); ?>"><img src="__STATIC__/home/image/logo.png" /></a>
                    ...
                    <?php if(is_array($cats) || $cats instanceof \think\Collection || $cats instanceof \think\Paginator): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?>
                         <div class="level-item">
                            <div class="first-level">
                              <dl>
                                <dt class="title"><a href="<?php echo url('index/lists', ['id'=>$key]); ?>"><?php echo $cat[0]; ?></a></dt>
                                ...
                                <dd><a href="<?php echo url('index/lists', ['id'=>$vo['category_id']]); ?>" class=""><?php echo $vo['category_name']; ?></a></dd>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                              </dl>
                            </div>
                              ...
                              <div class="section">
                                <div class="section-item clearfix no-top-border">
                                  ...
                                  <ul>
                                    ...
                                    <li> <a href="<?php echo url('index/lists', ['id'=>$vo['category_id']]); ?>"><?php echo $vo['category_name']; ?></a></li>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                  </ul>
                                </div>
                              </div>
    ...
    <div class="container">
        <div class="top-container">
            <div class="mid-area">
                <div class="slide-holder" id="slide-holder">
                    ...
                    <ul class="slideshow">
                        <li><a href="<?php echo url('index/lists'); ?>" class="item-large"><img class="ad-pic" src="__STATIC__/home/image/a1ec08fa513d2697b85e74c35dfbb2fb4216d89b.jpg" /></a></li>
                        <li><a href="<?php echo url('index/lists'); ?>" class="item-large"><img class="ad-pic" src="__STATIC__/home/image/63d0f703918fa0ec7c51e2912e9759ee3c6ddb9c.jpg" /></a></li>
                    </ul>
                </div>
        ...
        <div class="right-sidebar">
            <div class="right-ad">
                <ul class="slidepic">
                    <li><a href="<?php echo url('index/lists'); ?>"><img src="__STATIC__/home/image/72f082025aafa40f9205eb43a364034f79f01968.jpg" /></a></li>
                </ul>
            </div>
                    ...
                    <div class="floor-content">
                        <div class="floor-header">
                            ...
                            <ul class="reco-words">
                                ...
                                <li><a href="<?php echo url('lists/index', ['id'=>$vo['id']]); ?>"><?php echo $vo['category_name']; ?></a></li>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                <li><a href="<?php echo url('index/lists'); ?>" class="no-right-border no-right-padding" >全部<span class="all-cate-arrow"></span></a></li>
                            </ul>
                        </div>
                        ...
                        <ul class="itemlist eight-row-height">
                         <?php if($datas): if(is_array($datas) || $datas instanceof \think\Collection || $datas instanceof \think\Paginator): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <li class="j-card" style="margin: 4px 0 50px 5px;">
                                <a>
                                    <div class="imgbox">
