<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\phpStudy\WWW\localhost\tp50\public/../application/admin\view\category\index.html";i:1516822255;s:80:"D:\phpStudy\WWW\localhost\tp50\public/../application/admin\view\common\meta.html";i:1517148103;s:80:"D:\phpStudy\WWW\localhost\tp50\public/../application/admin\view\common\foot.html";i:1517148076;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="category_sorts">
					<input type="text" class="input-text" 
					value="<?php echo $vo['category_sort']; ?>" placeholder="" attr-id="<?php echo $vo['category_id']; ?>"
					id="category_sort" name="category_sort" style="width:120px;">
				</td>
				<td><?php echo date("Y-m-d H:i",$vo['category_create_time']); ?></td>
				<td class="td-status"><a href="<?php echo url('category/status',['category_id'=>$vo['category_id'],'category_status'=>$vo['category_status']==2?1:2]); ?>"><?php echo status($vo['category_status']); ?></a></td>
				<td class="td-manage">

				<a href="<?php echo url('category/index',['category_parent_id'=>$vo['category_id']]); ?>">获取子栏目</a>

				<a title="编辑" href="javascript:;" 
				onclick="o2o_s_add('编辑','<?php echo url('category/edit',['category_id'=>$vo['category_id']]); ?>','','510')"
				class="ml-5" style="text-decoration:none">
				<i class="Hui-iconfont">&#xe6df;</i></a> 

				<a title="删除" href="javascript:;" 
				onclick="o2o_del('<?php echo url('category/status',['category_id'=>$vo['category_id'],'category_status'=>3]); ?>')" class="ml-5"
			...
			<tr><td class="tp5-o2o"><?php echo $categorys->render(); ?></td></tr>
		</tbody>
	</table>
	</div>
</div>
...
<script type="text/javascript">
	var sort_url = {
		'category_url':"<?php echo url('category/category_sort'); ?>",
	}
</script> 
</body>
</html>