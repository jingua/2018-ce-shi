<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\phpStudy\WWW\localhost\tp50\public/../application/admin\view\deal\index.html";i:1517156543;s:80:"D:\phpStudy\WWW\localhost\tp50\public/../application/admin\view\common\meta.html";i:1517148103;s:80:"D:\phpStudy\WWW\localhost\tp50\public/../application/admin\view\common\foot.html";i:1517148076;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				onclick="o2o_s_add('编辑','<?php echo url('deal/edit',['id'=>$vo['id']]); ?>','','510')"
				class="ml-5" style="text-decoration:none">
				<i class="Hui-iconfont">&#xe6df;</i></a> 

				<a title="删除" href="javascript:;" 
				onclick="o2o_del('<?php echo url('deal/del',['id'=>$vo['id']]); ?>')" class="ml-5"
